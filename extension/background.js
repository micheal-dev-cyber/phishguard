// API proxy endpoint (python api_proxy.py --port 8080).
// Falls back to offline local analysis if the server is unreachable.
// On HF Spaces no REST API is exposed — local analysis is used automatically.
